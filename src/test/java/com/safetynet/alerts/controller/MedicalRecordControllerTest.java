...
class MedicalRecordControllerTest {
    ...
    /**
     * Test get all of the medical records
     * @throws Exception
     */
    @Test
    ...
    class UpdateMedicalRecordTests {
        ...
        /**
         * Returns 200 when successfully udpdated a record
         * @throws Exception
         */
        @Test
        ...
        /**
         * Tests that updating a firestation returns 404 when the person record is missing
         */
        @Test
        ...
        /**
         * Tests that updating a firestation returns 400 bad request when
         * the service throws IllegalArgumentException
         */
        @Test
    ...
    class DeleteMedicalRecordTests {
        ...
        /**
         * Returns 404 not found when no record exists
         * @throws Exception
         */
        @Test
